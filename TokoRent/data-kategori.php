				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="edit-kategori.php?id=<?php echo $row['category_id'] ?>" class="btn">Edit</a>
								<a href="proses-hapus.php?idk=<?php echo $row['category_id'] ?>" onclick="return confirm('Yakin ingin hapus ?')" class="btn delete">Hapus</a>
							</td>
						</tr>
						<?php }}else{ ?>
							<tr>
